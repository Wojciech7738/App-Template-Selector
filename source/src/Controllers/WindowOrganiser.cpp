...
void WindowOrganiser::run(int argc, char** argv) {
    ...
    std::unique_ptr<IJsonReaderWriter<std::tuple<std::string, std::vector<std::string>>>> lang_path_scanner = ReaderWriterFactory::createTemplateScanner(selected_language + "contents");
